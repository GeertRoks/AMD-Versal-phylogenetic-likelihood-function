...
public:
  ...
  WindowPassthroughGraph<WINDOW_SIZE, VECTOR_SIZE> graphs[NUM_GRAPHS] = {
    ...
    WindowPassthroughGraph<WINDOW_SIZE, VECTOR_SIZE>(20, 1),
    WindowPassthroughGraph<WINDOW_SIZE, VECTOR_SIZE>(20, 2),
    WindowPassthroughGraph<WINDOW_SIZE, VECTOR_SIZE>(20, 3)
  };
